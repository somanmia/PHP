...
<!..........START JAVA ARITCLE SECTION....................../>
		...
		<section id="main_java_left">
					 <div class="left_java">
						...
						<div class="video">
						        <iframe width="560" height="315" src="https://www.youtube.com/embed/xjcCi6Tzfxw" frameborder="0" allow="accelerometer;
			...
			<!.......End core HTML5......./>
             <!.....start HTML5 .............../>
			     <div class="left_java">
						...
						<div class="video">
						        <iframe width="560" height="315" src="https://www.youtube.com/embed/Mn9p5qRk_xU" frameborder="0" allow="accelerometer;
								       autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
								  </iframe>
						</div>
				<ul>
				  <li style="margin-left:0px;background:#F6783A;"><a href="##">1</a></li>
				  <li><a href="##">1</a></li>
				  <li><a href="##">2</a></li>
				  <li><a href="##">></a></li>
                 </ul>				
       ...
       <!..........START RIGHT SECTION.................../>
	       <div id="java_right_section">
				...
				<div class="java_develop">
				    <h3>HTML5 Learning</h3>
					<a href="https://docs.djangoproject.com/en/2.2/">Django</a>
					<a href="http://flask.palletsprojects.com/en/1.1.x/">Flask</a>
					<a href="www.google.com">PROJECT_3</a>
					<a href="https://www.youtube.com/watch?v=5RWjNAfATlA&list=PLJ-3-UkU_it9Vk3lVGqWD-dBCT3GKuarR">ADVANCED PROJECT</a>
				</div>
			 <div class="top_website">
			    <h3>Top 4 Website for <span style="color:#f37537">HTML5</span></h3>
				<ol>
				 <li> <a href=" https://www.javatpoint.com/python-tutorial">JAVA TPOINT</a></li>
			 	<li><a href="https://www.tutorialspoint.com/python/index.htm">TUTRIALSPOINT</a></li>
				<li><a href="https://docs.python.org/3/tutorial/index.html">HTML5</a></li>
				<li><a href="https://www.w3schools.com/python/">W3SCHOOLS</a></li>
				</ol>
             </div>	
         <div class="coding_pratcise">
		  <h3>Top 5 <span style="color:red">HTML5</span> BOOKS</h3>
		     <ol>
				 <li> <a href="##">1</a></li>
			 	<li><a href="##">2</a></li>
				<li><a href="###">3</a></li>
